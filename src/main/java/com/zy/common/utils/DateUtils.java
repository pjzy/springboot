...
public class DateUtils {
	...
	public static String formatDateToString(Date time, String format) {
		if (!simpleDateFormatMap.containsKey(format)) {
			simpleDateFormatMap.put(format, new SimpleDateFormat(format));
		}
	...
	public static String formatDateToString(Date time) {
		return formatDateToString(time,DATE_FORMAT_YMD);
	}
	...
	public static boolean isContainCurrent(List<String> dates) {
		boolean flag = false;
		if (!simpleDateFormatMap.containsKey(DATE_FORMAT_YMD)) {
			simpleDateFormatMap.put(DATE_FORMAT_YMD, new SimpleDateFormat(DATE_FORMAT_YMD));
		}
		SimpleDateFormat fmt = simpleDateFormatMap.get(DATE_FORMAT_YMD);
		Date date = new Date();
